...
## Ограничения
Так как протокол максимально простой, он не поддерживает обработку ошибок.
Также он не поддерживает `\n\n` в теле сообщений, так как использует эту последовательность в качестве терминатора запроса.
